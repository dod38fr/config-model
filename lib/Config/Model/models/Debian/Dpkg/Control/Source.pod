...
This field indicates the debian policy version number this package complies to. I<< Optional. Type uniline. default: '3.9.3'.  >>
...
If this field is present, then any Debian Maintainers listed in the Maintainer or Uploaders fields may upload the package directly to the Debian archive.  For more information see the "Debian Maintainer" page at the Debian Wiki - http://wiki.debian.org/DebianMaintainer. I<< Optional. Type uniline.  >>
