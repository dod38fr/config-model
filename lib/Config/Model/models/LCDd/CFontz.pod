...
Set the firmware version (New means >= 2.0) I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>

=head2 Reboot

Reinitialize the LCD's BIOS 
normally you shouldn't need this. I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>
