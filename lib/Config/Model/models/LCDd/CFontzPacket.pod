...
Reinitialize the LCD's BIOS on driver start. I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>

=head2 USB

Enable the USB flag if the device is connected to an USB port. For
serial ports leave it disabled. I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>
...
enable this flag. I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>

=head2 Size

Override the LCD size known for the selected model. Usually setting this
value should not be necessary.I<< Optional. Type uniline. default: '20x4'.  >>
