...
use ASC symbols for icons & bars I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>

=head2 DrawBorder

draw Border I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'yes'.  >>
