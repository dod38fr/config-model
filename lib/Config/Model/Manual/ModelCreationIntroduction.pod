...
The application that will use the configuration file. The application
...
You will get a GUI to create or update your model.

C<cme> will write the data structure in the correct directory.
