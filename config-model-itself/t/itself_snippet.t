...
# modify model
$meta_snippet_root->load(q!class:MasterModel::X_base_class2 element:X warn_if_match:C msg="found C in value"!);

$snippet_rw_obj->write_snippet(model_dir => $wr_snippet, model_file=> 'snippet.pl') ;
