...
or L<LcdProc|http://www.lcdproc.org/>.
...
or by a L<new read/write backend|http://search.cpan.org/~ddumont/Config-Model-2.083/lib/Config/Model/Backend/Any.pm#How_to_write_your_own_backend>.
