...
{
  $Config::Model::Exception::VERSION = '2.023';
}
use warnings ;
use strict;
use Data::Dumper ;
...
{
  $Config::Model::Exception::Syntax::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::Any::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::LoadData::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::Model::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::Load::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::RestrictedElement::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::UnavailableElement::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::ObsoleteElement::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::UnknownElement::VERSION = '2.023';
}
use Carp;
...
{
  $Config::Model::Exception::UnknownId::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::WrongType::VERSION = '2.023';
}
...
{
  $Config::Model::Exception::Xml::VERSION = '2.023';
}
